This is the specification file for conditional GAN & NF training and testing dataset - i-CLEVR
...
2. train.json
The file is for training. The number of training data is 18012.
